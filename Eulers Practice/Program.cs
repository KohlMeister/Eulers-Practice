...
namespace Eulers_Practice
{
    class Program
    {
        ...
        public static int problemTwo(int range)
        {
            //Problem 2
        ...
        public static int problemThree(long number)
        {
            //Problem 3
        ...
        public static long problemFive(long max, long startingPoint, int divideBy)
        {
            //Problem 5
        ...
        public static long problemSix(int numberOfNumbers)
        {
            //Problem 6
